...
// Regexp pattern para CPF e CNPJ.
var (
...
// IsCPF verifica se a string fornecida é um documento CPF válido.
...
// IsCNPJ verifica se a string fornecida é um documento CNPJ válido.
...
// isCPFOrCNPJ gera os dígitos de um determinado CPF ou CNPJ e os compara com os dígitos originais.
...
// cleanNonDigits remove cada runa que não seja um dígito.
...
// allEq verifica se todas as runas em uma determinada string são iguais.
...
// calculateDigit calcula o próximo dígito para o documento fornecido.
...
// toInt converte uma runa em um int.
